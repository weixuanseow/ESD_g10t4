...
@app.route("/book_test/<int:id>", methods=['POST'])
def book_test():
    # Get booking id
...
def processBookTest(booking_id):
    ...
    booking_URL = "http://localhost:5000/bookings/unavailable/" + booking_id
    ...
    # Inform the notification microservice
        ...
        print("Booking status ({:d}) sent to the error microservice:".format(code), booking_result)
        # Return 
        return {
                "code": 500,
